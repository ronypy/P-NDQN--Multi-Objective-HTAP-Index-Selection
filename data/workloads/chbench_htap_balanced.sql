-- ============================================================
-- CH-BENCHMARK HTAP BALANCED WORKLOAD
-- ============================================================
-- Designed for MORL-Index training with:
-- - 40% write operations (realistic HTAP)
-- - Phase variation (OLTP blocks, OLAP blocks, mixed)
-- - All CH-benchmark transaction types
-- - 300+ queries for better learning
-- ============================================================

-- ============================================================
-- PHASE 1: OLTP-HEAVY (New-Order + Payment transactions)
-- Write ratio: ~60%
-- ============================================================

-- New-Order Transaction Pattern (read stock, insert order)
...
SELECT i_price, i_name, i_data FROM item WHERE i_id = 200
SELECT s_quantity, s_data, s_dist_01 FROM stock WHERE s_i_id = 200 AND s_w_id = 1
UPDATE stock SET s_quantity = s_quantity - 3, s_ytd = s_ytd + 3, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 200
SELECT i_price, i_name, i_data FROM item WHERE i_id = 300
SELECT s_quantity, s_data, s_dist_01 FROM stock WHERE s_i_id = 300 AND s_w_id = 1
UPDATE stock SET s_quantity = s_quantity - 2, s_ytd = s_ytd + 2, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 300
...
SELECT i_price, i_name, i_data FROM item WHERE i_id = 400
SELECT s_quantity, s_data, s_dist_02 FROM stock WHERE s_i_id = 400 AND s_w_id = 1
...
UPDATE stock SET s_quantity = s_quantity - 6, s_ytd = s_ytd + 6, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 500
...
-- Order-Status Transaction (read-only OLTP)
...
-- Stock-Level Transaction (read-only OLTP)
...
-- More OLTP writes
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 100 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 200 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 300 AND s_quantity < 10

-- More Payment transactions
SELECT c_id FROM customer WHERE c_w_id = 1 AND c_d_id = 1 AND c_last = 'BARBARBAR'
SELECT c_first, c_middle, c_last, c_balance FROM customer WHERE c_w_id = 1 AND c_d_id = 1 AND c_id = 2
UPDATE customer SET c_balance = c_balance - 20.00, c_ytd_payment = c_ytd_payment + 20.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 1 AND c_id = 2
UPDATE district SET d_ytd = d_ytd + 20.00 WHERE d_w_id = 1 AND d_id = 1
UPDATE warehouse SET w_ytd = w_ytd + 20.00 WHERE w_id = 1
...
SELECT i_price, i_name, i_data FROM item WHERE i_id = 600
SELECT s_quantity, s_data, s_dist_03 FROM stock WHERE s_i_id = 600 AND s_w_id = 1
UPDATE stock SET s_quantity = s_quantity - 7, s_ytd = s_ytd + 7, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 600

-- ============================================================
-- PHASE 2: OLAP-HEAVY (Analytical queries)
-- Write ratio: ~0%
-- ============================================================
...
-- ============================================================
-- PHASE 3: MIXED HTAP (Concurrent OLTP + OLAP)
-- Write ratio: ~30%
-- ============================================================

-- New-Order while analytical running
SELECT c_discount, c_last, c_credit, w_tax FROM customer, warehouse WHERE w_id = 1 AND c_w_id = w_id AND c_d_id = 4 AND c_id = 15
...
SELECT i_price, i_name, i_data FROM item WHERE i_id = 700
UPDATE stock SET s_quantity = s_quantity - 8, s_ytd = s_ytd + 8, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 700

-- Analytical query interleaved
...
-- Payment transaction
UPDATE warehouse SET w_ytd = w_ytd + 25.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 25.00 WHERE d_w_id = 1 AND d_id = 4
UPDATE customer SET c_balance = c_balance - 25.00, c_ytd_payment = c_ytd_payment + 25.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 4 AND c_id = 15
...
UPDATE oorder SET o_carrier_id = 3 WHERE o_id = 50 AND o_d_id = 2 AND o_w_id = 1
UPDATE order_line SET ol_delivery_d = NOW() WHERE ol_o_id = 50 AND ol_d_id = 2 AND ol_w_id = 1
UPDATE customer SET c_balance = c_balance + 150.00, c_delivery_cnt = c_delivery_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 2 AND c_id = 10
...
-- New Order pattern
SELECT c_discount, c_last, c_credit, w_tax FROM customer, warehouse WHERE w_id = 1 AND c_w_id = w_id AND c_d_id = 5 AND c_id = 20
UPDATE district SET d_next_o_id = d_next_o_id + 1 WHERE d_w_id = 1 AND d_id = 5
SELECT i_price, i_name, i_data FROM item WHERE i_id = 800
UPDATE stock SET s_quantity = s_quantity - 4, s_ytd = s_ytd + 4, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 800
SELECT i_price, i_name, i_data FROM item WHERE i_id = 900
UPDATE stock SET s_quantity = s_quantity - 5, s_ytd = s_ytd + 5, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 900

-- Analytical
SELECT s_w_id, AVG(s_quantity) AS avg_qty, MIN(s_quantity) AS min_qty, MAX(s_quantity) AS max_qty FROM stock GROUP BY s_w_id

-- Payment
UPDATE warehouse SET w_ytd = w_ytd + 30.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 30.00 WHERE d_w_id = 1 AND d_id = 5
UPDATE customer SET c_balance = c_balance - 30.00, c_ytd_payment = c_ytd_payment + 30.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 5 AND c_id = 20

-- Stock level check
SELECT d_next_o_id FROM district WHERE d_id = 5 AND d_w_id = 1
SELECT COUNT(DISTINCT s_i_id) FROM order_line, stock WHERE ol_w_id = 1 AND ol_d_id = 5 AND ol_o_id < 500 AND ol_o_id >= 480 AND s_w_id = 1 AND s_i_id = ol_i_id AND s_quantity < 20

-- More mixed operations
SELECT c_id, c_first, c_last, c_balance FROM customer WHERE c_w_id = 1 AND c_d_id = 1 AND c_balance > 0
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 400 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 500 AND s_quantity < 10
...
-- ============================================================
-- PHASE 4: MORE OLTP (Heavy write phase)
-- Write ratio: ~70%
-- ============================================================

-- Rapid New-Order transactions
SELECT c_discount, c_last, c_credit, w_tax FROM customer, warehouse WHERE w_id = 1 AND c_w_id = w_id AND c_d_id = 6 AND c_id = 25
UPDATE district SET d_next_o_id = d_next_o_id + 1 WHERE d_w_id = 1 AND d_id = 6
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1000
UPDATE stock SET s_quantity = s_quantity - 3, s_ytd = s_ytd + 3, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1000
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1100
UPDATE stock SET s_quantity = s_quantity - 2, s_ytd = s_ytd + 2, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1100
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1200
UPDATE stock SET s_quantity = s_quantity - 4, s_ytd = s_ytd + 4, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1200

UPDATE warehouse SET w_ytd = w_ytd + 50.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 50.00 WHERE d_w_id = 1 AND d_id = 6
UPDATE customer SET c_balance = c_balance - 50.00, c_ytd_payment = c_ytd_payment + 50.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 6 AND c_id = 25

SELECT c_discount, c_last, c_credit, w_tax FROM customer, warehouse WHERE w_id = 1 AND c_w_id = w_id AND c_d_id = 7 AND c_id = 30
UPDATE district SET d_next_o_id = d_next_o_id + 1 WHERE d_w_id = 1 AND d_id = 7
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1300
UPDATE stock SET s_quantity = s_quantity - 6, s_ytd = s_ytd + 6, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1300
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1400
UPDATE stock SET s_quantity = s_quantity - 3, s_ytd = s_ytd + 3, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1400

UPDATE warehouse SET w_ytd = w_ytd + 35.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 35.00 WHERE d_w_id = 1 AND d_id = 7
UPDATE customer SET c_balance = c_balance - 35.00, c_ytd_payment = c_ytd_payment + 35.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 7 AND c_id = 30

-- Delivery batch
SELECT no_o_id FROM new_order WHERE no_d_id = 3 AND no_w_id = 1 ORDER BY no_o_id LIMIT 1
UPDATE oorder SET o_carrier_id = 5 WHERE o_id = 200 AND o_d_id = 3 AND o_w_id = 1
UPDATE order_line SET ol_delivery_d = NOW() WHERE ol_o_id = 200 AND ol_d_id = 3 AND ol_w_id = 1
UPDATE customer SET c_balance = c_balance + 200.00, c_delivery_cnt = c_delivery_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 3 AND c_id = 15

SELECT no_o_id FROM new_order WHERE no_d_id = 4 AND no_w_id = 1 ORDER BY no_o_id LIMIT 1
UPDATE oorder SET o_carrier_id = 6 WHERE o_id = 150 AND o_d_id = 4 AND o_w_id = 1
UPDATE order_line SET ol_delivery_d = NOW() WHERE ol_o_id = 150 AND ol_d_id = 4 AND ol_w_id = 1
UPDATE customer SET c_balance = c_balance + 180.00, c_delivery_cnt = c_delivery_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 4 AND c_id = 20

-- More New Orders
SELECT c_discount, c_last, c_credit, w_tax FROM customer, warehouse WHERE w_id = 1 AND c_w_id = w_id AND c_d_id = 8 AND c_id = 35
UPDATE district SET d_next_o_id = d_next_o_id + 1 WHERE d_w_id = 1 AND d_id = 8
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1500
UPDATE stock SET s_quantity = s_quantity - 5, s_ytd = s_ytd + 5, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1500
SELECT i_price, i_name, i_data FROM item WHERE i_id = 1600
UPDATE stock SET s_quantity = s_quantity - 7, s_ytd = s_ytd + 7, s_order_cnt = s_order_cnt + 1 WHERE s_w_id = 1 AND s_i_id = 1600

UPDATE warehouse SET w_ytd = w_ytd + 45.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 45.00 WHERE d_w_id = 1 AND d_id = 8
UPDATE customer SET c_balance = c_balance - 45.00, c_ytd_payment = c_ytd_payment + 45.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 8 AND c_id = 35

-- Stock replenishment
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 600 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 700 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 800 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 900 AND s_quantity < 10
UPDATE stock SET s_quantity = s_quantity + 91 WHERE s_w_id = 1 AND s_i_id = 1000 AND s_quantity < 10

-- Order status checks (read-only OLTP)
SELECT c_balance, c_first, c_middle, c_last FROM customer WHERE c_w_id = 1 AND c_d_id = 6 AND c_id = 25
SELECT o_id, o_carrier_id, o_entry_d FROM oorder WHERE o_w_id = 1 AND o_d_id = 6 AND o_c_id = 25 ORDER BY o_id DESC LIMIT 1
SELECT ol_i_id, ol_supply_w_id, ol_quantity, ol_amount, ol_delivery_d FROM order_line WHERE ol_w_id = 1 AND ol_d_id = 6 AND ol_o_id = 300

SELECT c_balance, c_first, c_middle, c_last FROM customer WHERE c_w_id = 1 AND c_d_id = 7 AND c_id = 30
SELECT o_id, o_carrier_id, o_entry_d FROM oorder WHERE o_w_id = 1 AND o_d_id = 7 AND o_c_id = 30 ORDER BY o_id DESC LIMIT 1
SELECT ol_i_id, ol_supply_w_id, ol_quantity, ol_amount, ol_delivery_d FROM order_line WHERE ol_w_id = 1 AND ol_d_id = 7 AND ol_o_id = 250

-- ============================================================
-- PHASE 5: BACK TO OLAP (End-of-day reporting)
-- Write ratio: ~5%
-- ============================================================
...
-- One last payment before close
UPDATE warehouse SET w_ytd = w_ytd + 100.00 WHERE w_id = 1
UPDATE district SET d_ytd = d_ytd + 100.00 WHERE d_w_id = 1 AND d_id = 1
UPDATE customer SET c_balance = c_balance - 100.00, c_ytd_payment = c_ytd_payment + 100.00, c_payment_cnt = c_payment_cnt + 1 WHERE c_w_id = 1 AND c_d_id = 1 AND c_id = 50
